...
def get_egd(args):
    transform_egd = transforms.Compose([
        # you can add other transformations in this list
        transforms.Resize([299, 299]),
        transforms.ToTensor()
    ])

    train_labeled_dataset = datasets.ImageFolder(root='/Data/jhshin/jfd_dataset/timm2/train/',transform=transform_egd)

    train_unlabeled_dataset = datasets.ImageFolder(root='/Data/jhshin/videos/LSSMSAYSK_2/',transform=TransformEGDMPL(args))

    test_dataset = datasets.ImageFolder(root='/Data/jhshin/jfd_dataset/timm2/validation/',transform=transform_egd)
